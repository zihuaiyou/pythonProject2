...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(MainWindow.modify)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "厚层控底加砂优化软件"))
        self.label_10.setText(_translate("MainWindow", "断裂韧性"))
        self.label_6.setText(_translate("MainWindow", "储层应力"))
        self.label_7.setText(_translate("MainWindow", "隔层应力"))
        self.label_8.setText(_translate("MainWindow", "液体压力"))
        self.label_15.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">储层厚度</span></p></body></html>"))
        self.label_11.setText(_translate("MainWindow", "期望控底高度比"))
        self.label_12.setText(_translate("MainWindow", "裂缝长度"))
        self.label_13.setText(_translate("MainWindow", "粒径、粘度"))
        self.comboBox.setItemText(0, _translate("MainWindow", "40/70目、30cp"))
        self.comboBox.setItemText(1, _translate("MainWindow", "40/70-70/140、30cp"))
        self.comboBox.setItemText(2, _translate("MainWindow", "70/140目、30cp"))
        self.comboBox.setItemText(3, _translate("MainWindow", "40/70目、200cp"))
        self.comboBox.setItemText(4, _translate("MainWindow", "40/70-70/140、200cp"))
        self.comboBox.setItemText(5, _translate("MainWindow", "70/140目、200cp"))
        self.pushButton.setText(_translate("MainWindow", "优化"))
