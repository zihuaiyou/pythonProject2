...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_resh = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_resh.setObjectName("lineEdit_resh")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_resh)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEdit_Q)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineEdit_E)
        ...
        self.lineEdit_v = QtWidgets.QLineEdit(self.groupBox)
        self.lineEdit_v.setObjectName("lineEdit_v")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.lineEdit_v)
        ...
        self.lineEdit_filt = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEdit_filt.setObjectName("lineEdit_filt")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEdit_filt)
        ...
        self.comboBox_size = QtWidgets.QComboBox(self.groupBox_2)
        self.comboBox_size.setObjectName("comboBox_size")
        self.comboBox_size.addItem("")
        self.comboBox_size.addItem("")
        self.comboBox_size.addItem("")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.comboBox_size)
        ...
        self.comboBox_time = QtWidgets.QComboBox(self.groupBox_2)
        self.comboBox_time.setObjectName("comboBox_time")
        self.comboBox_time.addItem("")
        self.comboBox_time.addItem("")
        self.comboBox_time.addItem("")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.comboBox_time)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_size.setItemText(0, _translate("MainWindow", "40/70"))
        self.comboBox_size.setItemText(1, _translate("MainWindow", "70/140"))
        self.comboBox_size.setItemText(2, _translate("MainWindow", "40/70-70/140"))
        self.label_13.setText(_translate("MainWindow", "压裂时间"))
        self.comboBox_time.setItemText(0, _translate("MainWindow", "60min"))
        self.comboBox_time.setItemText(1, _translate("MainWindow", "40min"))
        self.comboBox_time.setItemText(2, _translate("MainWindow", "20min"))
